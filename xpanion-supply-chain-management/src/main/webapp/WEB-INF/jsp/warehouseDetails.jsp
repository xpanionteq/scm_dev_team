       ...
       <li><a href="/adminHome"><i class="fa fa-dashboard"></i> <span>Home</span></a></li>
        <li class="treeview active" >
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="/warehouse"><i class="fa fa-circle-o"></i> Warehouse Master</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row input-sm">
        <!-- /.col -->
        <div class="col-md-8">
        <div class="box box-default" id="newWarehouseForm">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="form-group">
                  <label for="firstName">Warehouse Name <span style="color: red">*</span></label>
            ...
            <div class="col-md-6">
              <div class="form-group">
                  <label for="code">Warehouse Code<span style="color: red">*</span></label>
                  <input type="text" class="form-control" id="code">
              </div>
            <div class="form-group">
                  <label for="Email">Email ID <span style="color: red">*</span></label>
                  <input type="tel" class="form-control" id="warehouseEmail" maxlength="25">
              </div>  
            <div class="form-group">
                  <label for="mobileNumber">Contact Number <span style="color: red">*</span></label>
                  <input type="text" class="form-control" id="workPhone" maxlength="10">
              </div>
              <!-- /.form-group -->
            </div>
            <div class="col-md-2" align="right">
             <button type="button" class="btn btn-block btn-primary" id="warehouseSubmitButton">Submit</button>
             </div>
             <div class="col-md-2" align="right">
             <button type="button" class="btn btn-block btn-primary" id="warehouseSubmitButton">Cancel</button>
             </div>
          </div>
          <!-- /.row -->
        </div>
