			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview active"><a href="#"> <i
							class="fa fa-cog"></i> <span>Master Settings</span> <span
						...
						<ul class="treeview-menu">
							<li class="active"><a href="#"><i class="fa fa-circle-o"></i>
									Warehouse Master</a></li>
							<li><a href="#"><i class="fa fa-circle-o"></i> Route Master</a></li>
							<li><a href="/accountMaster"><i class="fa fa-circle-o">
							</i> Accounts Master</a></li>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<ol class="breadcrumb">
					...
					<li class="active"><a href="#">Warehouse Master</a></li>
				</ol>
			</section>
...
<div class="modal fade" id="rackData" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
 ...
 <div class="widget-user-header">
              ...
              <h3 class="widget-user-username" align="center" id="itemMod">Racks</h3>
              <h4 class="widget-user-desc" align="center" id="descMod">Description</h4>
            </div>
           
        <div class="box box-solid"  align="center">
            <div class="box-header with-border">
              <table id="rackTable" class="table table-bordered table-hover">
                <thead>
                <tr>
                 <th>SectionId</th>
                 <th>RackId</th>
   ...
   <div class="col-md-4" id="attrDivModal"></div>
  </div>
      </div>
      <div class="modal-footer">
       ...
       <div class="checkbox icheck pull-left">
        ...
        <button type="button" class="btn btn-secondary" data-dismiss="modal"> Close</button>
          				 ...
          				 <!-- /.col -->
        <div class="col-md-9">
        <div class="box box-default" id="newSectionRackForm">
        <div class="box-header with-border">
          <h3 class="box-title">Section and Racks</h3>
          ...
          <div class="row input-sm">
                                      ...
                                      <div class="col-md-4">
										<div class="form-group">
											<label for="sectionName">Section Name <span
												style="color: red">*</span></label> <input type="text"
												class="form-control" id="SectionName">
										</div>
									</div>
									<div class="col-md-2">
										<br> <i class="fa fa-plus-circle" id="addsectionBtn"
											aria-hidden="true"
											style="font-size: 30px; color: #3c8dbc; cursor: pointer;"
											></i>
									</div>
									<div class="col-md-4">
										<div class="form-group">
											<label for="rack">Rack Name <span
												style="color: red">*</span></label> <input type="text"
												class="form-control" id="rackName">
										</div>
									</div>
									<div class="col-md-2">
										<br> <i class="fa fa-plus-circle" id="addrackBtn"
											aria-hidden="true"
											style="font-size: 30px; color: #3c8dbc; cursor: pointer;"
											></i>
									</div>
             ...
             <button type="button" class="btn btn-block btn-primary" id="sectionSubmitButton">Submit</button>
             </div>
             <div class="col-md-4" align="right">
             <button type="button" class="btn btn-block btn-primary" id="sectioncancel Button">Cancel</button> -->
             </div>
								<!-- /.row -->
							</div>
							<!-- /.box-body -->
 ...
 <div class="modal fade" id="addsectionModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Add Sections and Racks</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
  ...
  <div class="col-md-12">
   ...
   <div class="form-group">
  <label for="man">Section<span style="color: red">*</span></label>
  <input type="text" class="form-control" id="newSection">
  <p class="help-block" id="newSectionEmptyMsg"><span style="color: red">This field is required *</span></p>
           <p class="help-block" id="newSectionAlready"><span style="color: red">Add new attribute please..</span></p>
             
   </div>
 
  <div class="form-group">
  <label for="man">Rack<span style="color: red">*</span></label>
  <input type="text" class="form-control" id="newRack">
  <p class="help-block" id="newRackEmptyMsg"><span style="color: red">This field is required *</span></p>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-dismiss="modal"> Close</button>
        <button type="button" onclick="form_submit()" class="btn btn-primary newAttributeSaveBtn" id="newAttributeSaveBtn"> Save</button>
      </div>
    </div>
  </div>
</div>					 -->	
	...
	<script
		...
		<script src="js/scripts/warehouseScript.js"></script>
