            ...
            <div class="box-header with-border">
                            ...
                            <div class="col-md-12">
                                <ul class="nav nav-tabs" role="tablist">
                                    <li role="presentation" class="active"><a href="#customerList" aria-controls="home" role="tab" data-toggle="tab">Customers</a></li>
                                    <li role="presentation" id ="adminListId"><a href="#vendorList" aria-controls="settings" role="tab" data-toggle="tab">Vendors</a></li>
                                 </ul>

                                <div class="tab-content">
                                    <div role="tabpanel" class="tab-pane fade in active" id="customerList">
                                            ...
                                            <div class="panel-heading">
                                             ...
                                             <div class="panel-body">
						                            ...
						                            <div class="table-responsive">
						                                <table id="customerTable" class="table table-bordered table-striped table-hover js-basic-example dataTable">
						                                    <thead>
						                                        <tr>
						                                            <th>Customer ID</th>
						                                            <th>Name</th>
                                       ...
                                       <div role="tabpanel" class="tab-pane fade in" id="vendorList">
                                       <div class="panel panel-default panel-post">
                                            <div class="panel-heading">
                                               <p>Vendors</p>
                                            </div>
