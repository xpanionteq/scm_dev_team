       ...
       <li><a href="/adminHome"><i class="fa fa-dashboard"></i> <span>Home</span></a></li>
        <li class="treeview active" >
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="#"><i class="fa fa-circle-o"></i> Accounts Master</a></li>
           </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Accounts Manager</a></li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="row input-sm">
        <!-- /.col -->
        <div class="col-md-8">
        <div class="box box-default collapsed-box" id="newaccountForm">
        <div class="box-header with-border">
          <h3 class="box-title">Add New Account</h3>

          <div class="box-tools pull-right">
            <button type="button" class="btn btn-box-tool" data-widget="collapse" id="minusButton"><i class="fa fa-plus"></i></button>
             </div>
          ...
          <div class="row input-sm">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="bankName">
                  </div>
                   <div class="form-group">
                  <label for="acNumber">Account Number<span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="acNumber">
                  </div>
                   <div class="form-group">
                   <label for="type">Account Type<span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="actyoe">
                  </div>
                   <div class="form-group">
             ...
             <button type="button" class="btn btn-block btn-primary" id="bankSubmitButton">Save</button>
             </div>
              <div class="col-md-5" align="right">
             <button type="button" class="btn btn-block btn-primary" id="cancel">cancel</button>
             </div>
              </div>
              </div>
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="acHolderName">
                  </div>
                   <div class="form-group">
                  <label for="ifsc">IFSC<span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="ifscNumber">
                  </div>
                   <div class="form-group">
                   <label for="upi">UPI ID<span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="upiId">
                  </div>
                 </div>
      ...
      <!-- <div class="col-lg-4 col-xs-6">
          ...
          <div class="small-box bg-yellow">
            <div class="inner">
              ...
              <p>Branch Name: CHERPULASSERY</p>
              <p>Account Number: 4264008700002418</p>
              <p>Account Holder Name: Unity Traders</p>
              <p>IFSC: PUNB0426400</p>
              <p>UPI ID: wretw@ybl</p>
            </div>
        ...
        <div class="col-md-10">
         <div class="box box-primary">
            ...
            <!-- /.box-body -->
                 ...
                 <!--   <a href="javascript:void(0)" class="product-title">PUNJAB NATIONAL BANK
                      <span class="pull-right"><i class="fa fa-pencil"></i> <i class="fa fa-trash"></i></span></a>
              <p>Branch Name: CHERPULASSERY</p>
              <p>Account Number: 4264008700002418</p>
              <p>Account Holder Name: Unity Traders</p>
              <p>IFSC: PUNB0426400</p>
...
<script src="js/scripts/accountScript.js"></script>
<!-- keyboard shortcuts -->
