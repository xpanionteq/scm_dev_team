...
<script  type="text/javascript" src="/examples/js/typeahead/0.11.1/typeahead.bundle.js"></script>
 <script type="text/javascript" src="js/scripts/purchaseOrder.js"></script>
 </head>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <span style="color: white" ><b>
        ...
        <li class="active"><a href="/purchases"><i class="fa fa-shopping-cart"></i> <span>Purchase</span></a></li>
  ...
  <div class="content-wrapper input-sm">
    ...
    <div  class="row">
    <!-- <div class="col-md-3">
    <a href="/contacts" class="btn btn-primary btn-block margin-bottom" id="newVendor">New Vendor</a>
    <div class="box box-solid">
          ...
          <!-- /.col -->
        <div class="col-md-12">
        <div class="box box-default" id="newPuchaseForm">
        
        <div class="box-body">
          <div class="row">
           <div class="col-sm-3 invoice-col">
          <b>Vendor <span style="color: red">*</span></b>
                  <select class="form-control select2" id="vendorSelect" style="width: 100%;">
                    <option value="select">--select--</option>
                  </select>
          
        </div>
        <div class="col-sm-1 invoice-col"><br><i class="fa fa-user-plus" style="cursor:pointer;font-size:30px" id="newVendor" title="Add New Vendor"></i></div>
        ...
        <div class="col-sm-3 invoice-col">
         <!-- <div class="form-group"> -->
               <b>Order Date <span style="color: red">*</span></b>
				 <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right" id="orderDate" placeholder="mm/dd/yyyy" required>
                <!-- </div> -->
                <!-- /.input group -->
              </div>
           </div>
          <div class="col-sm-3 invoice-col">
                ...
                <b>Delivery Date <span style="color: red">*</span></b>

                <div class="input-group date">
                  <div class="input-group-addon">
                    <i class="fa fa-calendar"></i>
                  </div>
                  <input type="text" class="form-control pull-right" id="deliveryDate"placeholder="mm/dd/yyyy" placeholder="mm/dd/yyyy" required>
                </div>
             </div> 
         ...
         <div class="col-sm-4">
                <div class="form-group">
                <b>Select Product <span style="color: red">*</span></b>
                <select id="productId"  name="ProductName" class="form-control select2" >
                <option value="select">--select--</option>
                  </select>
              ...
              <br><span style="float:right" align="center"><button id="but_add" class="btn btn-danger">Add</button></span>
         ...
         <div class="form-group">
               <b>Order Date <span style="color: red">*</span></b>
				 <div class="input-group date">
                  ...
                  <input type="date" class="form-control pull-right" id="orderDate">
                </div>
                /.input group
              </div>
        ...
        <!-- </div> -->
         <!-- <div class="col-sm-3 invoice-col">
        <div class="col-sm-10">
          <b>Invoice No <span style="color: red">*</span></b>
          <input type="text" class="form-control">
          </div>
           <div class="col-sm-10">
           <div class="form-group">
        ...
        <!-- <div class="col-sm-3 invoice-col">
        <div class="col-sm-10">
         <b>Cash/Credit <span style="color: red">*</span></b>
         ...
         <div class="col-sm-10">
         <b>Bill Type <span style="color: red">*</span></b>
                
                  <select class="form-control select">
                    <option>GST(B2B)P</option>
                    <option>GST(B2C)P</option>
                    <option>IGST(B2B)P</option>
                  </select>
          </div>
        </div> -->
           <div class="col-md-12"> </div>
            ...
            <!--   <div class="col-sm-3 invoice-col">
              <div class="col-sm-10">
               <div class="form-group">
                <b>Quantity <span style="color: red">*</span></b>
                  <input type="text" class="form-control" width="25%">
            </div>
             </div>
             </div> 
             --> 
        ...
        <table class="table table-sm table-striped" id="makeEditable">
     <thead>
      <tr>
        <th> Product ID</th>
...
<!-- <script src="js/scripts/purchaseScript.js"></script> -->
