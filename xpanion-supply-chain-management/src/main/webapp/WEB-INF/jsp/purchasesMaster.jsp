...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12" id="newPurchaseOrder" title="new purchase order" style="cursor:pointer;">
          <div class="info-box">
        ...
        <!-- /.col -->
        <div class="col-md-3 col-sm-6 col-xs-12" style="cursor:pointer;" id="pendingPurchaseOrder">
          <div class="info-box">
            <span class="info-box-icon bg-red"><i class="fa fa-shopping-cart"></i></span>

            <div class="info-box-content">
              <span class="info-box-text">Pending<br> Purchase Orders</span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12" style="cursor:pointer;">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Delivered<br> Purchase Orders</span>
              <span class="info-box-number">4</span>
            </div>
            <!-- /.info-box-content -->
          </div>
...
<script type="text/javascript" src="js/scripts/purchasesMasterScript.js"></script>
<!-- keyboard shortcuts -->
