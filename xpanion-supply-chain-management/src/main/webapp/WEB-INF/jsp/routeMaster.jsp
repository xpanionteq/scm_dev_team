       ...
       <li><a href="/adminHome"><i class="fa fa-dashboard"></i> <span>Home</span></a></li>
        <li class="treeview active" >
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="/routeMaster"><i class="fa fa-circle-o"></i> Route Master</a></li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Routes Master</a></li>
      </ol>
    </section>
      ...
      <div class="row input-sm">
        <div class="col-md-10">
         <div class="box box-primary">
           ...
           <!-- ----   <a data-toggle="modal" data-target="#newRoute" class="btn btn-default pull-right"><i class="fa fa-plus-circle"></i> Route</a>--->
       ...
       <!-- Modal -->
        ...
        <!-- /.col -->
        <div class="col-md-10">
        <div class="box box-default" id="newRouteForm">
        <div class="box-header with-border">
          ...
          <div class="row input-sm">
            <div class="col-md-6">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="route">
                  </div>
                   <div class="form-group">
                  <label for="starting point">Start Route<span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="startroute">
                  </div>
                   <div class="form-group">
                   <label for="via">Via <span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="via">
                  </div>
                   <div class="form-group">
                  <label for="final point">final Route <span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="finalroute">
                  </div>
                   <div class="form-group">
...
<script src="js/scripts/routeMasterScript.js"></script>
<!-- keyboard shortcuts -->
