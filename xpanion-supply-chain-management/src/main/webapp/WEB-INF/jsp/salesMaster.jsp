  ...
  <div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            <span class="info-box-icon bg-aqua"><i class="fa fa-plus" id="newSalesOrder" title="new sales order" style="cursor:pointer;"></i></span>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Pending<br> Sales Orders</span>
...
<script type="text/javascript" src="js/scripts/salesMasterScript.js"></script>
