...
<head>
  ...
  <title>SCM | Pending Purchase</title>
...
<script  type="text/javascript" src="/examples/js/typeahead/0.11.1/typeahead.bundle.js"></script>
 <script type="text/javascript" src="js/scripts/pendingPurchaseScript.js"></script>
 </head>
...
<div class="wrapper">
  ...
  <div class="content-wrapper input-sm">
    ...
    <div  class="row">
        ...
        <!--   <div class="row">
       -->    
           <div class="box box-default" id="pendingPurchase">
        
            <div class="box-body">
        
            
              <table id="pendingPurchaseTable" class="table table-bordered table-hover">
			      <thead>
				      <tr>
				            <th>Purchase ID</th>
				            <th>Vendor </th>
