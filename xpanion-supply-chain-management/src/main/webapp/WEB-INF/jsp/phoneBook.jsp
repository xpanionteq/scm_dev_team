  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <span style="color: white" ><b>
       ...
       <li class="active"><a href="/adminHome"><i class="fa fa-dashboard"></i> <span>Home</span></a></li>
        <li class="treeview" >
          <a href="#">
            <i class="fa fa-cog"></i>
...
<li><a href="#"><i class="fa fa-circle-o"></i> Accounts Master</a></li>
           </ul>
        </li>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"><a href="#">Phone Book</a></li>
  ...
  <div class="row">
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table id="phones" class="table-hover">
              <thead>
               <tr>
                  <th>ContactId</th>
                  <th>Contact Name</th>
          ...
          <!-- /.box -->
           ...
           <!-- /.col -->
        <div class="col-md-9">
        <div class="box box-default" id="newcontact">
        ...
        <!-- /.box-header -->
         ...
         <div class="col-md-6">
            ...
            <div class="form-group">
                  <label for="workPhone">Mobile Number</label>
                  <input type="text" class="form-control input-sm" id="mobileNumber" maxlength="11">
              </div>
              <div class="form-group">
           ...
           <div class="form-group" align="right">
             <button type="button" class="btn btn-block btn-primary" id="save">Submit</button>
             </div>
          </div>
 ...
 <!-- <div class="modal fade" id="newContact" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
             <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <input type="text" class="form-control input-sm" id="mobileNumber" maxlength="10">
              </div>
              <div class="form-group">
                  <label for="emailId">Email ID <span style="color: red">*</span></label>
                  <input type="text" class="form-control input-sm" id="email">
      ...
      <!--   <div class="box box-default" id="edit">
...
<script src="js/scripts/PhoneScript.js"></script>
